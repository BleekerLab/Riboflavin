...
ggsave(filename = "4_chmielewskii_riboflavin.png", plot = collected, width = 10, height = 10)
ggsave(filename = "4_chmielewskii_riboflavin.svg", plot = collected, width = 10, height = 10)
```
