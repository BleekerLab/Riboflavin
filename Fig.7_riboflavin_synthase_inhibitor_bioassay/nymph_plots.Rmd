...
ggsave(filename = "inhibitor_bioassay_boxplots.png", plot = collected, width = 10, height = 10)

ggsave(filename = "inhibitor_bioassay_boxplots.svg", plot = collected, width = 10, height = 10)
```
