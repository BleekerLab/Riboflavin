...
#              linetype = "dotted") +
  ...
  geom_line(aes(x = day,
                ...
                color = treatment),
            size = 1) +
  stat_compare_means(data = cumulative_flies %>% dplyr::filter(stage == "third") %>% dplyr::filter(day == 22), aes(x = day,
               y = number, 
               group = treatment), 
