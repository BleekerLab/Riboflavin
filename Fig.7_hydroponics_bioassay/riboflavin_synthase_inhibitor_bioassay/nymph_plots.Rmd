...
cumulative_flies_LA <- cumulative_flies_LA %>%
  mutate(first_instars = rowSums(cumulative_flies_LA[,8:11])) %>%
  mutate(second_instars = rowSums(cumulative_flies_LA[,9:11])) %>%
  mutate(third_instars = rowSums(cumulative_flies_LA[,10:11])) %>%
  mutate(fourth_instars = `4_fourth_instar`)
```
