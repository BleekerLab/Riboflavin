...
flies <- flies %>%
  ...
  dplyr::filter(id != "MM_rib_5")  %>%
  dplyr::filter(id != "MM_c_3") 

# MM_rib_4 and MM_rib_5 are taken out, because the leaves died 
# MM_c_3 is taken out, because it did not grow roots while all other control leaves did
...
cumulative_flies <- cumulative_flies %>%
  ...
  rel_cumul = tibble()
 for(i in c("MM_c_1", "MM_c_2", "MM_c_4", "MM_c_5", "MM_rib_1", "MM_rib_2", "MM_rib_3")){
...
cumulative_flies <- rel_cumul %>%
  unite("first_instars", MM_c_1:MM_rib_3, 
                                  na.rm = TRUE)  %>%
...
cumulative_flies <- rel_cumul %>%
  unite("second_instars", MM_c_1:MM_rib_3, 
                                  na.rm = TRUE)  %>%
...
cumulative_flies <- rel_cumul %>%
  unite("third_instars", MM_c_1:MM_rib_3, 
                                  na.rm = TRUE)  %>%
...
cumulative_flies <- rel_cumul %>%
  unite("fourth_instars", MM_c_1:MM_rib_3, 
                                  na.rm = TRUE)
...
auc_fourth <- auc %>%
  ...
  rel_cumul = tibble()
  for(i in c("MM_c_1", "MM_c_2", "MM_c_3", "MM_c_4", "MM_c_5", "MM_rib_1", "MM_rib_2", "MM_rib_3")){
