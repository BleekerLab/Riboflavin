...
# plots
```{r color palette}
palette <- c("#E69F00", "#CCCCCC", "#CCCCCC", "#56B4E9", "#CCCCCC")
```
...
collected <- ((p1 + p2) / (p3 + plot_spacer())) / guide_area() +
  plot_layout(guides = 'collect') +
  plot_annotation(tag_levels = 'A')

collected

ggsave(filename = "IL_bioassay.png", plot = collected, width = 10, height = 15)
ggsave(filename = "IL_bioassay.svg", plot = collected, width = 10, height = 15)
```
