...
On normal LA1840 plants, the number of eggs is increased compared to MM plants. Can we see the same effect when a LA1840 rootstock is used with a MM scion?
```{r egg boxplot, echo=FALSE, warning=FALSE, message=FALSE}
flies_wide %>%  
