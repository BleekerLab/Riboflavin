...
ggsave(filename = "graft_bioassay_option1.png", plot = development_plot1, width = 10, height = 12)

ggsave(filename = "graft_bioassay_option2.png", plot = development_plot2, width = 10, height = 12)
```
