...
ggsave(filename = "supplemental_graft_eggs.svg", plot = collected_eggs, width = 10, height = 12)

ggsave(filename = "supplemental_graft_eggs.png", plot = collected_eggs, width = 10, height = 12)
```
