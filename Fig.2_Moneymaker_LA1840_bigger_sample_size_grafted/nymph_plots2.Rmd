...
development_plot <- (p_cumulative + inset_element(auc_plot, 
                             left = 0.6, 
                             bottom = 0.025, 
                             right = 1, 
                             top = 0.55)) + guide_area() +
...
ggsave(filename = "graft_bioassay_lineplots_4th.svg", plot = development_plot, width = 15, height = 10)

ggsave(filename = "graft_bioassay_lineplots_4th.png", plot = development_plot, width = 15, height = 10)
```
